...
SOURCE_SPECS: Dict[str, SourceSpec] = {
    ...
    "internetarchivecomics": SourceSpec(
        id="internetarchivecomics",
        ...
        stability_score=5,
        notes="Public-domain/open-license allowlist only; scans are not chapter-normalized.",
    ),
    ...
    "standardebooks": SourceSpec(
        ...
        default_enabled=False,
        access="metadata",
        capabilities=("catalog", "detail", "download"),
        languages=("en",),
        coverage="public-domain",
        stability_score=4,
        notes="Curated public-domain ebooks; feed access and attribution policy are respected.",
    ),
}
