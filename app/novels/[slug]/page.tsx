    ...
    <div className="app-shell">
      ...
      <main className="novel-detail page-shell" style={{ "--novel-accent": novel.accent } as React.CSSProperties}>
        ...
        <section className="novel-detail__hero">
          <div className="novel-detail__visual">
            {novel.coverUrl ? (
              <StoryCover className="novel-detail__cover" src={novel.coverUrl} title={novel.title} priority />
            ) : (
            ...
            <small>{novel.sourceName ?? "Mực Chữ"} · {novel.chapterCount ?? novel.chapters.length} chương</small>
          </div>
