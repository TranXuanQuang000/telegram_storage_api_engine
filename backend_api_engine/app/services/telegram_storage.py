...
This module deliberately fails closed. A source must be explicitly enabled, its
asset hosts must be allow-listed, and the caller must attest a valid rights basis.
"""
